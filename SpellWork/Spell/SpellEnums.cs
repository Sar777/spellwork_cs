...
namespace SpellWork.Spell
{
    ...
    public enum SpellEffects
    {
        ...
        SPELL_EFFECT_ALTERNATIVE_EVENT                  = 160,
        ...
        SPELL_EFFECT_SUMMON_GAMEOBJECT                  = 171, // Summons gamebject
        ...
        SPELL_EFFECT_REMOVE_COMBAT                      = 176, // NYI
        ...
        SPELL_EFFECT_PLAY_SCENE_PACKAGE_2               = 195,
        SPELL_EFFECT_PLAY_SCENE_1                       = 196,
        SPELL_EFFECT_PLAY_SCENE_2                       = 197,
        SPELL_EFFECT_PLAY_SCENE_3                       = 198,
        ...
        SPELL_EFFECT_CREATE_AREATRIGGER_2               = 218,
        SPELL_EFFECT_219                                = 219,
        SPELL_EFFECT_ADD_GARRISON_FOLLOWER              = 220,
        SPELL_EFFECT_UNLOCK_GARRISON_MISSION            = 221,
        ...
        SPELL_EFFECT_TELEPORT_UNITS_2                   = 227,
    ...
    public enum AuraType
    {
        ...
        SPELL_AURA_RAID_PROC_FROM_CHARGE_WITH_VALUE             = 222,
        SPELL_AURA_RAID_PROC_FROM_CHARGE                        = 223,
        SPELL_AURA_224                                          = 224,
        SPELL_AURA_RAID_PROC_FROM_CHARGE_WITH_VALUE_2           = 225,
        ...
        SPELL_AURA_OVERRIDE_AUTO_ATTACK                         = 367,
        ...
        SPELL_AURA_CAST_WHILE_WALKING_2                         = 377,
        SPELL_AURA_378                                          = 378,
        SPELL_AURA_INCREASE_MANA_REGEN                          = 379,
        SPELL_AURA_MOD_GLOBAL_COOLDOWN_BY_HASTE                 = 380,  // Allows melee abilities to benefit from haste GCD reduction
        SPELL_AURA_381                                          = 381,
        SPELL_AURA_MOD_PET_STAT_PERCENT                         = 382,
        ...
        SPELL_AURA_MOD_REST_GAIN_PCT                            = 386,
        SPELL_AURA_MOD_VOID_TRANS_COSTS                         = 387,
        SPELL_AURA_MOD_TAXI_FLIGHT_SPEED                        = 388,  // NYI
        SPELL_AURA_389                                          = 389,
        SPELL_AURA_390                                          = 390,
        SPELL_AURA_391                                          = 391,
        SPELL_AURA_392                                          = 392,
        SPELL_AURA_MOD_DEFLECT_FRONT_SPELLS_CHANCE_PCT          = 393,
        SPELL_AURA_BONUS_LOOT_ROLL_MOP                          = 394,
        SPELL_AURA_AREATRIGGER                                  = 395,
        SPELL_AURA_TRIGGER_SPELL_AT_POWER_AMOUNT                = 396,
        SPELL_AURA_397                                          = 397,
        SPELL_AURA_398                                          = 398,
        SPELL_AURA_399                                          = 399,
        SPELL_AURA_MOD_SKILL_VALUE                              = 400,
        SPELL_AURA_401                                          = 401,
        SPELL_AURA_OVERRIDE_DISPLAY_POWER                       = 402,
        ...
        SPELL_AURA_PROC_FROM_SPELL                              = 408,
        SPELL_AURA_409                                          = 409,
        SPELL_AURA_410                                          = 410,
        SPELL_AURA_MOD_MAX_CHARGES                              = 411,  // NYI
        ...
        SPELL_AURA_427                                          = 427,
        SPELL_AURA_428                                          = 428,
        SPELL_AURA_MOD_PET_DAMAGE_PERCENT                       = 429,
        ...
        SPELL_AURA_438                                          = 438,
        SPELL_AURA_439                                          = 439,
        SPELL_AURA_MOD_MULTISTRIKE_DAMAGE_PCT                   = 440,
        SPELL_AURA_MOD_MULTISTRIKE_CHANCE_PCT                   = 441,
        SPELL_AURA_MOD_READINESS_PCT                            = 442,
        SPELL_AURA_MOD_LEECH_PCT                                = 443,
        SPELL_AURA_444                                          = 444,
        SPELL_AURA_445                                          = 445,
        SPELL_AURA_446                                          = 446,
        ...
        SPELL_AURA_RESET_COOLDOWNS_ON_DUEL_REQUEST              = 460,
        SPELL_AURA_461                                          = 461,
        SPELL_AURA_RESOLVE                                      = 462,
        SPELL_AURA_CONVER_CRIT_RATING_PCT_TO_PARRY_RATING       = 463,
        SPELL_AURA_MOD_ATTACK_POWER_OF_BONUS_ARMOR              = 464,
        SPELL_AURA_MOD_BONUS_ARMOR_FLAT                         = 465,
        ...
        SPELL_AURA_BONUS_LOOT_ROLL_WOD                          = 469,
        SPELL_AURA_MOD_VERSATILITY_PCT                          = 471,
        SPELL_AURA_472                                          = 472,
        SPELL_AURA_PREVENT_DURABILITY_LOSS_FROM_COMBAT          = 473,
        SPELL_AURA_474                                          = 474,
        SPELL_AURA_ALLOW_USING_GAMEOBJECTS_WHILE_MOUNTED        = 475,
        SPELL_AURA_MOD_CURRENCY_GAIN_2                          = 476,
        SPELL_AURA_477                                          = 477,
        SPELL_AURA_478                                          = 478,
        SPELL_AURA_479                                          = 479,
        SPELL_AURA_480                                          = 480,
        SPELL_AURA_DEATH_RUNES                                  = 481,
        SPELL_AURA_SELFIE                                       = 482,
        SPELL_AURA_TRANSFORM_SUPPRESSION                        = 483, // 6.1.2
        TOTAL_AURAS,
    }
    ...
    public enum Targets
    {
        ...
        TARGET_UNK_116                          = 116,
        TARGET_UNK_117                          = 117,
        TARGET_UNIT_TARGET_AREA_RAID            = 118,
        TARGET_UNK_119                          = 119,
        TARGET_UNK_120                          = 120,
        TARGET_UNK_121                          = 121,
        TARGET_UNK_122                          = 122,
    ...
    {
        SPELL_ATTR8_ALL                              = 0xFFFFFFFF,
        SPELL_ATTR8_NONE                             = 0x00000000,
    ...
    {
        SPELL_ATTR10_ALL                             = 0xFFFFFFFF,
        SPELL_ATTR10_NONE                            = 0x00000000,
    ...
    {
        SPELL_ATTR11_ALL                             = 0xFFFFFFFF,
        SPELL_ATTR11_NONE                            = 0x00000000,
    ...
    {
        SPELL_ATTR12_ALL                             = 0xFFFFFFFF,
        SPELL_ATTR12_NONE                            = 0x00000000,
    ...
    {
        SPELL_ATTR13_ALL                             = 0xFFFFFFFF,
        SPELL_ATTR13_NONE                            = 0x00000000,
